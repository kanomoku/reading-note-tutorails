...
```
参考： [正则表达式(.*?)惰性匹配()](https://blog.csdn.net/qq_37699336/article/details/84981687)
...
|        |                                                              |
|        | [参考中文](https://learn.microsoft.com/zh-cn/dotnet/standard/base-types/anchors-in-regular-expressions)<br />[参考英文](https://learn.microsoft.com/en-us/dotnet/standard/base-types/anchors-in-regular-expressions) |

参考：[正则字符边界](https://blog.csdn.net/weixin_37646636/article/details/130504043)
