...
|                                                              |                                                              |          |
| 方式3                                                        |                                                              |          |
| 1. `git checkout release`<br />2. `git pull origin master`   | `git pull origin master`<br />相当于<br />`git fetch origin master`+ `git merge origin/master` |          |
|                                                              |                                                              |          |
| 方式4                                                        |                                                              |          |
...
### 场景4：代码回合 ☞ release分支代码 回合到  v0118分支

| 命令--------------------------------------------------------------------------------------------------------------------------------------------------------- | 作用 | 延展阅读                                                     |
| :----------------------------------------------------------- | :--- | :----------------------------------------------------------- |
| 1. `git fetch origin release v0118`<br />2. `git checkout -b release origin/release`<br />3. `git merge origin/v0118`<br />4. `git push origin HEAD:v0118` |      | [参考](https://blog.csdn.net/u010312474/article/details/107915694) |
|                                                              |      |                                                              |
